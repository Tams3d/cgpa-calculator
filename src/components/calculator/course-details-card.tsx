  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          For past semesters, enter your overall SGPA. For the current semester, enter grades
          subject by subject.
        </CardDescription>
      </CardHeader>
      <CardContent className="flex flex-col gap-3.5">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-xs text-muted-foreground">
            Rajalakshmi Engineering College is live now. More colleges are coming soon.
          </p>
        </div>
